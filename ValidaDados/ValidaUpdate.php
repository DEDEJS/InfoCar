...
class ShowInput{
    public function Input($Alterar,$ValidaCadastroManutencao,$ValidaCadastro,$Placa,$Peca,$ValorPeca,$MaoDeObra,$Data){        
        switch($Alterar){
          case "Placa":
            echo '
      ...
      <input type="submit" value="Alterar"> 
          ...
          <input type="number" placeholder="Alterar a kilometragem" name="Kilometragem" id="Kilometragem" >
           <input type="submit" value="Alterar"> 
                ';
            break;
            case "Data":
