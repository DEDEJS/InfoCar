...
<form action="#" method="post">
  <?php 
 $ShowInput -> Input($Alterar,$ValidaCadastroManutencao,$ValidaCadastro,$Placa,$Peca,$ValorPeca,$MaoDeObra,$Data);
  ?>
</form>
</section>
<?php

$AlterarDados ->  AlterarDados($Alterar,$IdAlterarManutencao,$IdAlterarCarro,$Conecta,$ValidaCadastroManutencao,$ValidaCadastro,$Placa,$Peca,$ValorPeca,$MaoDeObra);  
?>
</body>
</html>
